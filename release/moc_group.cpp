...
Q_CONSTINIT static const qt_meta_stringdata_Group_t qt_meta_stringdata_Group = {
    {
        ...
        QT_MOC_LITERAL(6, 12),  // "groupCreated"
        QT_MOC_LITERAL(19, 0),  // ""
...
void Group::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Group::*)();
            if (_t _q_method = &Group::groupCreated; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
